#!/usr/bin/env bash
#SBATCH --job-name=chimed_sft_exp3 # create a short name for your job
...
DATA_PATH="/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/train_ceval_cmmlu.json"
...
OUTPUT_PATH="$MODEL_ROOT_DIR/output_exp3"
...
export run_name='medical_sft_hf_exp3'
