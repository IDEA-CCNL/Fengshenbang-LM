#!/usr/bin/env bash
#SBATCH --job-name=chimed_cmd_sft # create a short name for your job
...
DATA_ARGS="\
        ...
        --train_file /cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/train_cmd_sft.json \
        --val_file /cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/valid_cmd_sft.json \
        --test_file /cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/test_cmd_sft.json \
        --use_mpu \
        "

MODEL_ARGS="\
        --model_path /cognitive_comp/common_checkpoint/llama2_hf_13b_step191000 \
        --tokenizer_path /cognitive_comp/common_checkpoint/llama2_hf_13b_step191000 \
        --learning_rate 5e-5 \
...
MODEL_CHECKPOINT_ARGS="\
        ...
        --save_ckpt_path ${MODEL_ROOT_DIR}/ckpt_chimed_cmd_sft_v2 \
        "

        # --load_ckpt_path /cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/ckpt_chimed/model-epepoch=00-ststep=5600.ckpt \
