#!/usr/bin/env bash
#SBATCH --job-name=chimed_sft_exp2 # create a short name for your job
...
DATA_PATH="/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/train_icl7w_chimed10w.json"
...
MODEL_PATH="/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/output_v2/checkpoint-405000"
OUTPUT_PATH="$MODEL_ROOT_DIR/output_exp2"
...
export run_name='medical_sft_hf_exp2'
