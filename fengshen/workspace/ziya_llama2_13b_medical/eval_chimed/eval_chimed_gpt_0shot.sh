#!/bin/bash
#SBATCH --job-name=chimed-gpt-0shot # create a short name for your job
...
# MODEL_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/output_exp5/checkpoint-63242
