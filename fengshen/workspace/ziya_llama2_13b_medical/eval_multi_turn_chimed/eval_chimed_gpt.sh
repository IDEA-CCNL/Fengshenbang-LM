#!/bin/bash
#SBATCH --job-name=eval_multiturn # create a short name for your job
...
MODEL_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/output_exp5/checkpoint-189726
...
DEV_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/multi_turn_chimed_test.tail100.json
