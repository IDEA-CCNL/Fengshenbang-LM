#!/bin/bash
#SBATCH --job-name=ccks_chimedgpt # create a short name for your job
...
MODEL_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/output_datav6/checkpoint-2704
...
echo $SAVE_PATH
DEV_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/med_llm_ner_data/ccks2019-data/ccks2019.dev.json
