#!/bin/bash
#SBATCH --job-name=ner_medicalbaichuan # create a short name for your job
...
# MODEL_PATH='/cognitive_comp/ganruyi/huggingface_models/Taiyi-LLM'

prefix=`basename $MODEL_PATH`
MODEL_NAME="medicalgpt-baichuan"
TASK="ner"
SAVE_PATH=./${TASK}_${SLURM_JOB_NAME}_${prefix}_predict_0shot_${SLURM_JOB_ID}.json
echo $SAVE_PATH
DEV_PATH=/cognitive_comp/ganruyi/Fengshenbang-LM/fengshen/workspace/ziya_llama2_13b_medical/data/chimst.dev.json
