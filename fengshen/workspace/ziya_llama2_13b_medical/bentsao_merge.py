...
def main(
    ...
    model.save_pretrained('/cognitive_comp/ganruyi/huggingface_models/bentsao-7b-v1')
    tokenizer.save_pretrained('/cognitive_comp/ganruyi/huggingface_models/bentsao-7b-v1')
    ...
    def evaluate(
        ...
        **kwargs,
        ...
        prompt = f'"下面是一个问题，运用医学知识来正确回答提问.\n### 问题:\n{instruction}\n### 回答:\n"'
...
if __name__ == "__main__":
    main(base_model='/cognitive_comp/ganruyi/huggingface_models/llama-7b-hf', lora_weights='/cognitive_comp/ganruyi/huggingface_models/lora-llama-med')