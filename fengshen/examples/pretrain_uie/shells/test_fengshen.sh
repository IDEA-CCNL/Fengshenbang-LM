...
task=Test_Fengshen
dataset=SciCN
model_name=FengshenUIE_NER  # [Randeng-BART-139M-SUMMARY
...
DATA_DIR=/cognitive_comp/yangjing/Fengshenbang-LM-data/datasets_eval/zh_text2spotasoc/entity_zh_aligned/${dataset}
