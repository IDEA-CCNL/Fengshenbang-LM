...
DIR_PATH=/cognitive_comp/yangjing/Fengshenbang-LM-data/log/${task}_${dataset}_${model_name}_b${batch_size}_lr${learning_rate}_wm${warmup_ratio}_noise${spot_noise}
mkdir -p ${DIR_PATH}
