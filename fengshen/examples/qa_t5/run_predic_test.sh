...
ROOT_DIR=/cognitive_comp/hejunqing/projects/CMRC/models/v1_bs8_test/
...
TRAINER_ARGS="
    ...
    --do_eval_only \
    --prediction_res_path $ROOT_DIR/predictions_epoch07_sampling \
...
#--ckpt_path /cognitive_comp/hejunqing/projects/CCQA/randend_t5_784M_finetune/v1/ckpt/model-epoch=19-train_loss=0.0515.ckpt \
MODEL_ARGS="
    --ckpt_path $ROOT_DIR/ckpt/model-epoch=07-val_loss=0.6451-val_rougeL_fmeasure=0.790.ckpt/ \
    --pretrained_model_path /cognitive_comp/hejunqing/projects/ChineseSquad/models/pretrained_epoch9/ \
