...
#SBATCH -c 32 # cpu-cores per task (>1 if multi-threaded tasks)
...
MODEL_NAME=wenzhong-gpt-110M-chinese-bpe
...
MODEL_ARGS="\
        --model_path /cognitive_comp/common_data/Huggingface-Models/IDEA-CCNL/Wenzhong2.0-GPT2-110M/ \
        --learning_rate 1e-5 \
        --weight_decay 1e-1 \
        --warmup_ratio 0.01 \
        "
