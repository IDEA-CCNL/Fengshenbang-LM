...
from fengshen.data.megatron_dataloader.dataset_utils import get_indexed_dataset_
from fengshen.data.megatron_dataloader.realm_dataset_utils import get_block_samples_mapping
...
def get_ict_dataset(args, use_titles=True, query_in_block_prob=1):
...
class ICTDataset(Dataset):
    ...
    def __init__(self, name, block_dataset, title_dataset, data_prefix,
                 ...
                 seed, tokenizer, use_titles=True, use_one_sent_docs=False, binary_head=False):
        self.name = name
        self.seed = seed
