...
class GPT2QADataModel(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        return DataLoader(self.train_data, shuffle=True,
                          batch_size=self.train_batchsize, pin_memory=False, num_workers=self.args.num_workers)

    def val_dataloader(self):
        return DataLoader(self.valid_data, shuffle=False,
                          batch_size=self.valid_batchsize, pin_memory=False, num_workers=self.args.num_workers)
...
if __name__ == '__main__':
    import argparse
    modelfile = '/raid/wuziwei/pretrained_model_hf/yuyuan'
    modelfile = '/raid/wuziwei/pretrained_model_hf/gpt2-chinese-cluecorpussmall'
    datafile = '/raid/wuziwei/data_test/en_medical_qa.txt.shuf'
    ...
    testml = GPT2QADataset(data_path=datafile, args=args)
