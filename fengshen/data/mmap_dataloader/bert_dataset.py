...
class BertDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # for i in range(120):
        #     print(sample["input_ids"].numpy()[i],self.tokenizer.decode([sample["input_ids"].numpy()[i]]))
        return sample
...
def pad_and_convert_to_numpy(
    ...
    labels = [-100] * max_seq_length  # hf no mask label is -100, not -1
