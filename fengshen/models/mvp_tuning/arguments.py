...
class ModelArguments:
    ...
    nle_prefix: bool = field(
        default=False,
        metadata={
            "help": "Will use nle prefix during training"
        }
    )
    prompt: bool = field(
        default=False,
    ...
    nle_prefix_len: int = field(
        default=2,
        metadata={
            "help": "The length of nle prompt"
        }
    )
    prefix_fusion_way: str = field(
        default='concat',
        metadata={
            "help": "how to fuse multi prefixs"
        }
    )
    used_triplets_type: str = field(
        default='none',
        metadata={
            "help": "how to fuse multi prefixs"
        }
