...
from training.trainer_qa import CommonsenseQuestionAnsweringTrainer
...
def get_trainer(args):
    ...
    dataset = CSQA(tokenizer, data_args, training_args, qa_args)

    trainer = CommonsenseQuestionAnsweringTrainer(
        model=model,
        args=training_args,
