...
_DEV_FILE = "../SAFE/data/phys/statement/dev.new_statement.jsonl"
_TRAINING_FILE = "../SAFE/data/phys/statement/train.new_statement.jsonl"
            ...
            for idx, example in enumerate(examples):            
                ...
                yield idx, {
                    ...
                    "triplets_a": {'individual_view_triplets': example["statements"][0]['triplets'],
                                    ...
                                    'group_view_triplets': example["statements"][0]['triplets'],
                                    'retri_view_triplets': example["statements"][0]['triplets'],
                    ...
                    "triplets_b":   {'individual_view_triplets': example["statements"][1]['triplets'],
                                    'latent_view_triplets': '',
                                    'group_view_triplets': example["statements"][1]['triplets'],
                                    'retri_view_triplets': example["statements"][1]['triplets'],
