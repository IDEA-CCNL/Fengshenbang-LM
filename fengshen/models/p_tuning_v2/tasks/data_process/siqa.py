...
_DEV_FILE = "../SAFE/data/socialiqa/statement/dev.retri_statement.jsonl"
_TRAINING_FILE = "../SAFE/data/socialiqa/statement/train.retri_statement.jsonl"
            ...
            for idx, example in enumerate(examples):            
                ...
                yield idx, {
                    ...
                    "triplets_a": {'individual_view_triplets': example["statements"][0]['triplets'],
                                    'latent_view_triplets': '',
                                    'group_view_triplets': '[SEP]'.join(example['question']["choices"][0]['retri_triplets']),
                                    'retri_view_triplets': '[SEP]'.join(example['question']["choices"][0]['retri_triplets']),
                                    'selected_individual_view_triplets': example["statements"][0]['triplets'],
                                    'meaning_view_triplets': ''},
                    "triplets_b":  {'individual_view_triplets': example["statements"][1]['triplets'],
                                    'latent_view_triplets': '',
                                    'group_view_triplets': '[SEP]'.join(example['question']["choices"][1]['retri_triplets']),
                                    'retri_view_triplets': '[SEP]'.join(example['question']["choices"][1]['retri_triplets']),
                    ...
                    "triplets_c":  {'individual_view_triplets': example["statements"][2]['triplets'],
                                    'latent_view_triplets': '',
                                    'group_view_triplets': '[SEP]'.join(example['question']["choices"][2]['retri_triplets']),
                                    'retri_view_triplets': '[SEP]'.join(example['question']["choices"][2]['retri_triplets']),
                    ...
                    #                 'group_view_triplets': '[SEP]'.join(example["statements"][3]['group_view_triplets']),
                    #                 'retri_view_triplets': '[SEP]'.join(example["statements"][3]['retri_view_triplets'][0:5]),
                    ...
                    #                 'retri_view_triplets': '[SEP]'.join(example["statements"][4]['retri_view_triplets'][0:5]),
