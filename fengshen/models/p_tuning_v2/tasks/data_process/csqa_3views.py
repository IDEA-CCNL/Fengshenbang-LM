...
# _TEST_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/dev.3views_in_split_final_hope_20%.jsonl"
# _TRAINING_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/train.3views_in_split_final_hope_20%.jsonl"
# _DEV_FILE="/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/test.3views_in_split_final_hope_20%.jsonl"
#_TEST_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/test.3views_no_annoated.jsonl"
_TEST_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/dev.3views_no_annoated.jsonl"
_TRAINING_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/train.3views_no_annoated.jsonl"
_DEV_FILE="/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/dev.3views_no_annoated.jsonl"
# _TEST_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/test.leadboard.3views.jsonl"
# _TRAINING_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/train.leadboard.3views.jsonl"
# _DEV_FILE="/cognitive_comp/huangyongfeng/fight_for_something/HGN/data/csqa/merged_data/dev.leadboard.3views.jsonl"
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for idx, example in enumerate(examples):            
                ...
                yield idx, {
                    ...
                    "triplets_a": {'individual_view_triplets': '[SEP]'.join(example["statements"][0]['individual_view_triplets']),
                                    'latent_view_triplets': '[SEP]'.join(example["statements"][0]['latent_view_triplets'][0:2]),
                                    'group_view_triplets': '[SEP]'.join(example["statements"][0]['group_view_triplets'][0:20]),
                                    'retri_view_triplets': '[SEP]'.join(example["statements"][0]['retri_view_triplets']),
                                    'selected_individual_view_triplets': example["statements"][0]['selected_individual_view_triplets'],
                                    'meaning_view_triplets': example["statements"][0]['meaning_view_triplets']},
                    "triplets_b": {'individual_view_triplets': '[SEP]'.join(example["statements"][1]['individual_view_triplets']),
                                    'latent_view_triplets': '[SEP]'.join(example["statements"][1]['latent_view_triplets'][0:2]),
                                    'group_view_triplets': '[SEP]'.join(example["statements"][1]['group_view_triplets'][0:20]),
                                    'retri_view_triplets': '[SEP]'.join(example["statements"][1]['retri_view_triplets']),
                                    'selected_individual_view_triplets': example["statements"][1]['selected_individual_view_triplets'],
                                    'meaning_view_triplets': example["statements"][1]['meaning_view_triplets']},
                    "triplets_c": {'individual_view_triplets': '[SEP]'.join(example["statements"][2]['individual_view_triplets']),
                                    'latent_view_triplets': '[SEP]'.join(example["statements"][2]['latent_view_triplets'][0:2]),
                                    'group_view_triplets': '[SEP]'.join(example["statements"][2]['group_view_triplets'][0:20]),
                                    'retri_view_triplets': '[SEP]'.join(example["statements"][2]['retri_view_triplets']),
                                    'selected_individual_view_triplets': example["statements"][2]['selected_individual_view_triplets'],
                                    'meaning_view_triplets': example["statements"][2]['meaning_view_triplets']},
                    "triplets_d": {'individual_view_triplets': '[SEP]'.join(example["statements"][3]['individual_view_triplets']),
                                    'latent_view_triplets': '[SEP]'.join(example["statements"][3]['latent_view_triplets'][0:2]),
                                    'group_view_triplets': '[SEP]'.join(example["statements"][3]['group_view_triplets'][0:20]),
                                    'retri_view_triplets': '[SEP]'.join(example["statements"][3]['retri_view_triplets']),
                                    'selected_individual_view_triplets': example["statements"][3]['selected_individual_view_triplets'],
                                    'meaning_view_triplets': example["statements"][3]['meaning_view_triplets']},
                    "triplets_e": {'individual_view_triplets': '[SEP]'.join(example["statements"][4]['individual_view_triplets']),
                                    ...
                                    'group_view_triplets': '[SEP]'.join(example["statements"][4]['group_view_triplets'][0:20]),
