...
_TEST_FILE ="/cognitive_comp/huangyongfeng/fight_for_something/qagnn/data/riddlesense_dataset/rs_dev_twoviews.jsonl"
_TRAINING_FILE ="/cognitive_comp/huangyongfeng/fight_for_something/qagnn/data/riddlesense_dataset/rs_train_twoviews.jsonl"
_DEV_FILE="/cognitive_comp/huangyongfeng/fight_for_something/qagnn/data/riddlesense_dataset/rs_dev_twoviews.jsonl"
# few_shot_rate = 0.3
# _URLS = {
...
class RSQA(datasets.GeneratorBasedBuilder):
    """The FETAQA dataset"""
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for idx, example in enumerate(examples):            
                ...
                yield idx, {
                    ...
                    "triplets_a": {'individual_view_triplets': example['question']['choices'][0]["triplets"],
                                    'latent_view_triplets': example['question']['choices'][0]["triplets"],
                                    'group_view_triplets': '[SEP]'.join(example['question']['choices'][0]["retri_triplets"][0:2]),
                                    'retri_view_triplets': '[SEP]'.join(example['question']['choices'][0]["retri_triplets"][0:2]),
                                    'selected_individual_view_triplets': example['question']['choices'][0]["triplets"],
                                    'meaning_view_triplets': example['question']['choices'][0]["triplets"]},

                    "triplets_b": {'individual_view_triplets': example['question']['choices'][1]["triplets"],
                                    'latent_view_triplets': example['question']['choices'][1]["triplets"],
                                    'group_view_triplets': '[SEP]'.join(example['question']['choices'][1]["retri_triplets"][0:2]),
                                    'retri_view_triplets': '[SEP]'.join(example['question']['choices'][1]["retri_triplets"][0:2]),
                                    'selected_individual_view_triplets': example['question']['choices'][1]["triplets"],
                                    'meaning_view_triplets': example['question']['choices'][1]["triplets"]},

                    "triplets_c": {'individual_view_triplets': example['question']['choices'][2]["triplets"],
                                    'latent_view_triplets': example['question']['choices'][2]["triplets"],
                                    'group_view_triplets': '[SEP]'.join(example['question']['choices'][2]["retri_triplets"][0:2]),
                                    'retri_view_triplets': '[SEP]'.join(example['question']['choices'][2]["retri_triplets"][0:2]),
                                    'selected_individual_view_triplets': example['question']['choices'][2]["triplets"],
                                    'meaning_view_triplets': example['question']['choices'][2]["triplets"]},

                    "triplets_d": {'individual_view_triplets': example['question']['choices'][3]["triplets"],
                                    'latent_view_triplets': example['question']['choices'][3]["triplets"],
                                    'group_view_triplets': '[SEP]'.join(example['question']['choices'][3]["retri_triplets"][0:2]),
                                    'retri_view_triplets': '[SEP]'.join(example['question']['choices'][3]["retri_triplets"][0:2]),
                                    'selected_individual_view_triplets': example['question']['choices'][3]["triplets"],
                                    'meaning_view_triplets': example['question']['choices'][3]["triplets"]},

                    "triplets_e": {'individual_view_triplets': example['question']['choices'][4]["triplets"],
                                    'latent_view_triplets': example['question']['choices'][4]["triplets"],
                                    'group_view_triplets': '[SEP]'.join(example['question']['choices'][4]["retri_triplets"][0:2]),
                                    'retri_view_triplets': '[SEP]'.join(example['question']['choices'][4]["retri_triplets"][0:2]),
                                    'selected_individual_view_triplets': example['question']['choices'][4]["triplets"],
                                    'meaning_view_triplets': example['question']['choices'][4]["triplets"]},
                }
# >>> import json
