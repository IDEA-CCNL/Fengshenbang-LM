...
_TEST_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/graph-soft-counter/data/obqa/statement/test.good_triple_fact_mvp_statement.jsonl"
_TRAINING_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/graph-soft-counter/data/obqa/statement/train.good_triple_fact_mvp_statement.jsonl"
_DEV_FILE = "/cognitive_comp/huangyongfeng/fight_for_something/graph-soft-counter/data/obqa/statement/test.good_triple_fact_mvp_statement.jsonl"
            ...
            features=datasets.Features(
                {
                    ...
                    "meta_triple": datasets.Value("string"),
        ...
        with open(filepath, encoding="utf-8") as f:
            ...
            for idx, example in enumerate(examples):            
                ...
                yield idx, {
                    ...
                    "answer": example['question']['choices'][label_dict[example["answerKey"]]]['text'],
                    "fact": example['fact1'],
                    "meta_triple": example["statements"][label_dict[example["answerKey"]]]['triplets'],
                    "statement": example['question']['stem']+" [SEP] "+example['question']['choices'][label_dict[example["answerKey"]]]['text']+" [SEP] "+example['fact1']+" [SEP] "+example["statements"][label_dict[example["answerKey"]]]['triplets'],
