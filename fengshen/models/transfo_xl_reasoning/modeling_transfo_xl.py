...
from fengshen.models.transfo_xl_denoise.configuration_transfo_xl_denoise import \
...
class TransfoXLPreTrainModel(PreTrainedModel):
    """
...
class TransfoXLModel(TransfoXLPreTrainModel):
