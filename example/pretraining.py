...
class taskModel(nn.Module):
    def __init__(self, pre_train_dir: str, dropout_rate: float):
        ...
        self.bert_encoder = model_mlm_type[args.model_type].from_pretrained(pre_train_dir)
    ...
    def forward(self, input_ids, input_mask, input_seg,labels=None,is_training=False):
        bert_output = self.bert_encoder(input_ids=input_ids, attention_mask=input_mask, token_type_ids=input_seg,labels=labels)  # (bsz, seq, dim)
